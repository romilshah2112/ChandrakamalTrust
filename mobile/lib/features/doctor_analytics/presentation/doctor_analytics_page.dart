...
class _DoctorAnalyticsPageState extends State<DoctorAnalyticsPage> {
  ...
  bool _loading = true;
  String? _error;
  DoctorDashboardAnalyticsModel? _analytics;
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          _ChartCard(
                            ...
                            child: _ThreeDVerticalBarChart(data: analytics.patientsByAgeGroup),
                          ),
                          const SizedBox(height: 16),
                          _ChartCard(
                            title: 'Revenue for the Day',
                            child: _HorizontalRevenueChart(data: analytics.revenueForDay),
                          ),
                          const SizedBox(height: 16),
                          _ChartCard(
                            title: 'Revenue by Week',
                            child: _ThreeDVerticalBarChart(data: analytics.revenueByWeek),
                          ),
                          const SizedBox(height: 16),
                          _ChartCard(
                            title: 'Revenue by Month',
                            child: _ThreeDVerticalBarChart(data: analytics.revenueByMonth),
                          ),
                        ],
                      ),
                    ),
...
class _ThreeDPieChart extends StatelessWidget {
  ...
  final List<AnalyticsPointModel> data;
          ...
          children: chartData.asMap().entries.map((entry) {
            ...
            return Row(
              ...
              children: [
                ...
                Text('${entry.value.label} (${entry.value.value.toStringAsFixed(0)})'),
              ],
            );
          }).toList(),
        ),
...
class _HorizontalRevenueChart extends StatelessWidget {
  const _HorizontalRevenueChart({required this.data});
