...
public interface IPatientDataService
{
    ...
    Task<PatientDataResponse?> GetByIdAsync(int patientDataId, CancellationToken cancellationToken);
    Task<IReadOnlyList<PatientListItemResponse>> ListAsync(string? query, CancellationToken cancellationToken);
